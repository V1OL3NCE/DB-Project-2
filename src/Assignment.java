...
public class Assignment {
    ...
    public String toString(){
        return "INSERT INTO Assignment (assignment_ID, offering_ID, assignment_Name, assignment_Type_ID) VALUES (" + assignmentID + ", " + offeringID + ", '" + assignmentName + "', " + assignmentType + ");";
    }
